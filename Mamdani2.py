...
numeric_level_bajo = fuzz.interp_membership(numeric, numericBajo, 80)
numeric_level_med = fuzz.interp_membership(numeric, numericMed, 80)
numeric_level_alto = fuzz.interp_membership(numeric, numericAlto, 80)
...
# Rule 2 -HABILITAR
subrule1 = (concept_level_reg * 0.5 + numeric_level_med)
subrule2 = (concept_level_reg* 0.5 + numeric_level_alto)
...
# Rule 3 - PROMOCIONAR
subrule3 = (concept_level_bueno * 0.2 + numeric_level_alto * 1.2)
subrule4 = (concept_level_exc * 0.2 + numeric_level_alto * 1.2)
